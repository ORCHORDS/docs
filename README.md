...
Public company-wide documentation for ORCHORDS governance, security, privacy, data, AI, engineering, operations, resilience, people, compliance, customer trust, legal, finance, tax, treasury, ethics, communications, marketing, partnerships, procurement, records, quality, internal audit, support, commercial, project delivery, knowledge management, strategy, research, customer success, sustainability, corporate development, releases, product, accessibility, standards, templates, and SOPs.
...
Authorized routine documentation maintenance is performed directly on **`main`**. Feature branches and pull requests are not required for routine documentation growth or maintenance.
