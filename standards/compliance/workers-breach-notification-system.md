...
- `documentation/categories/compliance/soc2-audit-trail.md` — breach events feed into SOC 2 audit trail
- `documentation/categories/compliance/audit-log-immutable-r2.md` — immutable logs are evidence in breach investigations
- `documentation/categories/compliance/workers-access-control-audit.md` — access anomalies feed breach detection
- `documentation/categories/compliance/gdpr-consent-logging.md` — consent state relevant to notification obligations
