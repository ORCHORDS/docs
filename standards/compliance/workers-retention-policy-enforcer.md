...
- `documentation/categories/compliance/gdpr-data-deletion-pipeline.md` — right-to-erasure (Art. 17) vs. retention
- `documentation/categories/compliance/workers-data-subject-access-request.md` — DSAR pulls data before deletion
- `documentation/categories/compliance/audit-log-immutable-r2.md` — audit logs may have longer independent retention
- `documentation/categories/compliance/soc2-audit-trail.md` — SOC 2 requires log retention for 1 year minimum
