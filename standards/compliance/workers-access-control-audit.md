...
- `documentation/categories/compliance/soc2-audit-trail.md` — SOC 2 uses this access log as evidence
- `documentation/categories/compliance/audit-log-immutable-r2.md` — immutable append-only log companion
- `documentation/categories/compliance/workers-breach-notification-system.md` — access anomalies feed breach detection
- `documentation/categories/compliance/hipaa-phi-encryption.md` — PHI access must be logged per HIPAA § 164.312(b)
- `documentation/categories/compliance/workers-data-subject-access-request.md` — audit log included in DSAR exports
