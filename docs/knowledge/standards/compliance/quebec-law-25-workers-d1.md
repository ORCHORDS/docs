...
## Related
- `/documentation/docs/policies/compliance/pipeda-canada-compliance.md`
- `/documentation/docs/policies/compliance/gdpr-consent-management-cloudflare-workers.md`
- `/documentation/docs/policies/compliance/automated-decision-making-profiling-transparency.md`
