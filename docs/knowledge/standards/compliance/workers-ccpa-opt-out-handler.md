...
- `documentation/docs/policies/compliance/cookie-consent-banner.md` — GDPR consent banner; complements CCPA opt-out
- `documentation/docs/policies/compliance/pii-detection-scrubber.md` — strips PII from logs before third-party forwarding
- `documentation/docs/policies/compliance/gdpr-consent-logging.md` — consent audit trail pattern
- `documentation/docs/policies/compliance/workers-data-subject-access-request.md` — DSAR fulfillment pipeline
