...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/agent-observability-2026.md` and `documentation/docs/policies/patterns/agent-eval-2026.md`.
...
- `documentation/docs/policies/patterns/agent-observability-2026.md` — the OTel GenAI substrate
- `documentation/docs/policies/patterns/agent-eval-2026.md` — the eval-as-deploy-gate pattern
- `documentation/docs/policies/patterns/distributed-tracing-otel.md` — the OTel substrate
- `documentation/docs/policies/lessons/lazy-fail-evidence-discipline.md` — verify before believing
- `documentation/docs/policies/patterns/structured-logging.md` — log shape for events
