...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/mcp-server-patterns.md`.
...
- `documentation/docs/policies/patterns/mcp-server-patterns.md` — the broader server design
- `documentation/docs/policies/security/ai-agent-security.md` — the threat model
- `documentation/docs/policies/security/prompt-injection-defense.md` — what to do when auth is bypassed
- `documentation/docs/policies/cloudflare/agents-sdk-best-practices.md` — a Cloudflare-native MCP path
