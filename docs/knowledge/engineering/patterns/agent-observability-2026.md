...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/distributed-tracing-otel.md` and `documentation/docs/policies/patterns/agent-eval-2026.md`.
...
- `documentation/docs/policies/patterns/agent-eval-2026.md` — observability feeds the evaluator
- `documentation/docs/policies/patterns/structured-logging.md` — log shape for events
- `documentation/docs/policies/patterns/mcp-server-patterns.md` — MCP servers that emit OTel
- `documentation/docs/policies/cloudflare/ai-gateway-best-practices.md` — the proxy/gateway layer
