...
- `documentation/docs/policies/devtools/workers-wrangler-custom-builds.md` — configuring esbuild's `sourcemap` option
- `documentation/docs/policies/devtools/workers-bundle-size-analysis.md` — keeping bundle + map sizes in budget
