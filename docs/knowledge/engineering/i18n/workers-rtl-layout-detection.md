...
- `documentation/docs/policies/i18n/workers-locale-negotiation.md` — full locale negotiation algorithm with KV session caching
- `documentation/docs/policies/i18n/hreflang-sitemap-generation.md` — hreflang annotations for RTL/LTR URL variants
- `documentation/docs/policies/i18n/workers-currency-formatting-intl.md` — locale-aware number formatting
