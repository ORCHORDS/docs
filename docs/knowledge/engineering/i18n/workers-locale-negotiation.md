...
- `documentation/docs/policies/i18n/workers-rtl-layout-detection.md` — applying RTL direction after locale is negotiated
- `documentation/docs/policies/i18n/hreflang-sitemap-generation.md` — generating alternate URLs for each supported locale
- `documentation/docs/policies/i18n/workers-icu-plural-rules.md` — using the negotiated locale for plural form selection
