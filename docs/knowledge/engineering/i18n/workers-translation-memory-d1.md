...
- `documentation/docs/policies/i18n/translation-import-export-d1.md` — XLIFF/PO import pipelines feeding the same D1 database
- `documentation/docs/policies/i18n/workers-icu-plural-rules.md` — plural-form strings stored alongside TM data
- `documentation/docs/policies/i18n/workers-locale-negotiation.md` — selecting source/target language pair from request headers
