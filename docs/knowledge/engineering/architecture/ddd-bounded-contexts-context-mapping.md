...
- `documentation/docs/policies/architecture/event-sourcing-cqrs-projections.md`
- `documentation/docs/policies/architecture/strangler-fig-migration-pattern.md`
- `documentation/docs/policies/architecture/saga-pattern-distributed-transactions.md`
...
- Domain-Driven Design with TypeScript — https://khalilstemmler.com/articles/docs/policies/domain-driven-design/
