...
- `documentation/docs/policies/architecture/backend-for-frontend-pattern.md`
- `documentation/docs/policies/architecture/api-versioning-strategy.md`
- `documentation/docs/policies/architecture/rate-limiting-architecture-workers.md`
- `documentation/docs/policies/architecture/cdn-architecture.md`
- `documentation/docs/policies/architecture/function-as-a-service-patterns.md`
