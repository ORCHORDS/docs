...
- `documentation/docs/policies/architecture/event-driven-architecture.md`
- `documentation/docs/policies/patterns/transactional-outbox-pattern.md`
- `documentation/docs/policies/architecture/microservices-communication-patterns.md`
