...
- `/documentation/docs/policies/performance/dead-code-elimination.md`
- `/documentation/docs/policies/performance/javascript-tree-shaking-dead-code-elimination.md`
- `/documentation/docs/policies/performance/workers-module-initialization-lazy-loading.md`
- `/documentation/docs/policies/performance/workers-cold-start-optimization.md`
- `/documentation/docs/policies/performance/pages-functions-bundle-size-optimization.md`
