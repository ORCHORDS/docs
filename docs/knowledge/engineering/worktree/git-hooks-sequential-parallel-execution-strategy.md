...
- `documentation/docs/policies/worktree/git-hooks-lefthook-monorepo.md`
- `documentation/docs/policies/worktree/git-hooks-husky-lint-staged-commitlint.md`
- `documentation/docs/policies/worktree/pre-commit-hooks-comparison-2026.md`
- `documentation/docs/policies/worktree/pre-push-hooks-comprehensive-validation.md`
