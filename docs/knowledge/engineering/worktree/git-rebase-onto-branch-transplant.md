...
## Related
- `/documentation/docs/policies/worktree/git-rebase-interactive.md`
- `/documentation/docs/policies/worktree/git-rebase-vs-merge-2026.md`
- `/documentation/docs/policies/worktree/git-rerere.md`
- `/documentation/docs/policies/worktree/stacked-prs-workflow-2026.md`
- `/documentation/docs/policies/worktree/cherry-pick-revert-bisect.md`
