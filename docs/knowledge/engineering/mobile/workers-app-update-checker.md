...
- `documentation/docs/policies/mobile/workers-app-config-remote.md` — feature flags & remote config complement update gating
- `documentation/docs/policies/mobile/mobile-api-versioning.md` — API deprecation strategy that pairs with forced updates
- `documentation/docs/policies/mobile/workers-session-refresh-token-rotation.md` — force-logout on version-gated auth changes
