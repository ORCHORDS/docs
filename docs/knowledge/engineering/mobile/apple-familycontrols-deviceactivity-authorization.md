...
3. Store opaque system selection tokens only in appropriately protected app/group storage required by the app and extensions. Do not log or analytics-encode the selected applications/docs/policies/domains.
