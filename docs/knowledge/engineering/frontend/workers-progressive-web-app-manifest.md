...
- `documentation/docs/policies/frontend/workers-server-sent-events-stream.md` — push alternative for real-time updates
- `documentation/docs/policies/frontend/workers-image-optimization-pipeline.md` — offline-cached images should use transformed URLs
