...
- `documentation/docs/policies/frontend/workers-progressive-web-app-manifest.md` — offline-fallback page can reference optimized images
- `documentation/docs/policies/frontend/workers-a11y-header-injection.md` — inject responsive `<picture>` markup via HTMLRewriter
