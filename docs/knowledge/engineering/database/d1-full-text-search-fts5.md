...
- `documentation/docs/policies/database/d1-schema-version-tracking.md` — migration runner for applying the FTS5 DDL
- `documentation/docs/policies/database/d1-json-column-queries.md` — indexing JSON fields alongside FTS columns
- `documentation/docs/policies/database/d1-row-level-security-pattern.md` — combining RLS filters with FTS MATCH
