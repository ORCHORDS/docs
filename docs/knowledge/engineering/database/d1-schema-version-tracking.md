...
- `documentation/docs/policies/database/d1-full-text-search-fts5.md` — FTS5 setup as a migration (version 3 example)
- `documentation/docs/policies/database/d1-json-column-queries.md` — adding expression indexes via migrations
- `documentation/docs/policies/database/d1-row-level-security-pattern.md` — tenant_id column added via migration
