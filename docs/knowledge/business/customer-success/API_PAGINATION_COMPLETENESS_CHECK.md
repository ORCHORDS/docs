...
4. **Establish authoritative state.** Collect cursor, stable sort key, filters, item identifiers, duplicates, and terminal condition. Prefer protocol responses, audit events, reproducible queries, signed artifacts, and machine-readable output to screenshots. Preserve raw values before normalization.
...
- [JSON:API Pagination Recommendations](https://jsonapi.org/recommendations/#pagination)
