...
3. Gather and normalize the data needed for customer VAT identity, VIES responses, transport evidence, invoices, and recapitulative reporting. Map every critical field to an accountable source and resolve contradictions.
...
- https://taxation-customs.ec.europa.eu/taxation/vat/vat-identification-numbers_en
