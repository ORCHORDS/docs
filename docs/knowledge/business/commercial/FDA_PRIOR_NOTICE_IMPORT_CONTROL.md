...
3. Gather and normalize the data needed for advance food shipment data, facility and product identifiers, transport timing, confirmation, and resubmission. Map every critical field to an accountable source and resolve contradictions.
