...
3. Gather and normalize the data needed for import designations, eligible duties, exports or destruction, substitution, and duplicate-use prevention. Map every critical field to an accountable source and resolve contradictions.
