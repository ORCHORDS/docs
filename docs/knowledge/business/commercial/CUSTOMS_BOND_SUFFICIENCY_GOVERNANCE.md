...
3. Gather and normalize the data needed for single-transaction and continuous bonds, surety authorization, revenue exposure, and insufficiency notices. Map every critical field to an accountable source and resolve contradictions.
...
- https://www.cbp.gov/trade/priority-issues/revenue/bonds
