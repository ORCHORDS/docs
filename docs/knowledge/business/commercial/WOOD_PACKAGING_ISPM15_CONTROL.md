...
3. Gather and normalize the data needed for regulated pallets, crates and dunnage, approved treatments, IPPC marks, repairs, and border interception. Map every critical field to an accountable source and resolve contradictions.
...
- https://www.aphis.usda.gov/plant-imports/wood-packaging-material
