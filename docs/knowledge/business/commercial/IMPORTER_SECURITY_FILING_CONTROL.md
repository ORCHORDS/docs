...
3. Gather and normalize the data needed for ocean-carrier loading, ten importer data elements, carrier data, amendments, and CBP acceptance. Map every critical field to an accountable source and resolve contradictions.
