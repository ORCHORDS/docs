...
3. Gather and normalize the data needed for applicable consumer-product rules, reasonable testing programs, certificate content, and production changes. Map every critical field to an accountable source and resolve contradictions.
...
- https://www.ecfr.gov/current/title-16/chapter-II/part-1110
