...
3. Gather and normalize the data needed for brand-owner responsibility, unique allocation, packaging levels, check digits, product change, and barcode verification. Map every critical field to an accountable source and resolve contradictions.
