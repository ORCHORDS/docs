...
3. Gather and normalize the data needed for commercial-device approval, calibration, tare, unit pricing, scanner accuracy, inspection, and local adoption. Map every critical field to an accountable source and resolve contradictions.
...
- https://www.nist.gov/pml/owm/handbook-44-current-edition
- https://www.nist.gov/pml/owm/handbook-130-current-edition
