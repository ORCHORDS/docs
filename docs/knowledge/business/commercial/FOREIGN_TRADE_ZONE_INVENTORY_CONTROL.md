...
3. Gather and normalize the data needed for admissions, zone status, approved activity, production, waste, removals, and annual reconciliation. Map every critical field to an accountable source and resolve contradictions.
...
- https://www.cbp.gov/trade/entry-summary/foreign-trade-zones
