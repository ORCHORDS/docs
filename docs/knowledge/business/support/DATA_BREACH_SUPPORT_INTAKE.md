# Personal Data Breach Support Intake

## Purpose and scope

Use this runbook for possible personal-data exposure. Its goal is to turn a customer symptom into safe, reproducible evidence and a bounded request to the team that owns the failing component. It does not replace engineering investigation, incident command, legal review, or a product service commitment.
...
Capture service, discovery time, event period, data categories, approximate subjects, containment. Preserve exact machine output instead of paraphrasing it. The topic-specific control is to avoid legal conclusions before privacy review. Never request passwords, private keys, session cookies, bearer credentials, payment data, or an unrestricted production dataset. Redact unrelated personal and proprietary material before attachment.
...
- [https://csrc.nist.gov/pubs/sp/800/61/r2/final](https://csrc.nist.gov/pubs/sp/800/61/r2/final)
- [https://www.ftc.gov/business-guidance/resources/data-breach-response-guide-business](https://www.ftc.gov/business-guidance/resources/data-breach-response-guide-business)
