...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/docs/policies/cloudflare/workflows-best-practices.md`.
...
- `documentation/docs/policies/cloudflare/workflows-best-practices.md` — pre-2026 patterns
- `documentation/docs/policies/cloudflare/durable-objects-best-practices.md` — the lower-level primitive
- `documentation/docs/policies/cloudflare/workers-queues-patterns.md` — for non-durable async work
- `documentation/docs/policies/cloudflare/agents-sdk-best-practices.md` — agents + workflows together
- `documentation/docs/policies/lessons/human-in-the-loop.md` — `waitForEvent` is the durable HITL primitive
