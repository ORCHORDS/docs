...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/docs/policies/patterns/rag-architecture-2026.md`.
...
- `documentation/docs/policies/cloudflare/vectorize-2026.md` — the raw vector store
- `documentation/docs/policies/patterns/rag-architecture-2026.md` — RAG topology
- `documentation/docs/policies/patterns/multi-agent-orchestration.md` — agents calling AI Search as a tool
- `documentation/docs/policies/patterns/mcp-server-patterns.md` — the MCP integration pattern
