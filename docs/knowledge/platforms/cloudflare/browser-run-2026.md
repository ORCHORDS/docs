...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/docs/policies/cloudflare/browser-run-best-practices.md`.
...
- `documentation/docs/policies/cloudflare/browser-run-best-practices.md` — pre-2026 patterns
- `documentation/docs/policies/cloudflare/sandbox-2026.md` — for code-execution rather than browser-driving
- `documentation/docs/policies/cloudflare/ai-search-2026.md` — retrieval layer often paired with browser agents
- `documentation/docs/policies/patterns/agent-observability-2026.md` — OTel spans for browser actions
- `documentation/docs/policies/lessons/human-in-the-loop.md` — the HITL handoff pattern
- `documentation/docs/policies/security/ai-agent-security.md` — Rule of Two applies to browser creds and egress
