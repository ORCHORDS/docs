...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/docs/policies/cloudflare/vectorize-best-practices.md` (which covers the 2024 surface).
...
- `documentation/docs/policies/cloudflare/vectorize-best-practices.md` — pre-2026 patterns
- `documentation/docs/policies/cloudflare/ai-search-2026.md` — the managed retrieval layer built on top of Vectorize
- `documentation/docs/policies/cloudflare/ai-gateway-best-practices.md` — caching and rate-limiting in front of Vectorize
- `documentation/docs/policies/patterns/rag-architecture-2026.md` — RAG topology
- `documentation/docs/policies/patterns/multi-tenant-data-isolation.md` — namespaces vs per-tenant databases
