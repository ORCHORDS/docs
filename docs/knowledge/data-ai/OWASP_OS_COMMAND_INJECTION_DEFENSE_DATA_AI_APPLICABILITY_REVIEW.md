# OWASP OS Command Injection Defense Data and AI Applicability Review

## Purpose

Evaluate whether current **OS Command Injection Defense** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
