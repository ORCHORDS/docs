# OWASP Dependency Graph SBOM Data and AI Applicability Review

## Purpose

Evaluate whether current **Dependency Graph SBOM** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
