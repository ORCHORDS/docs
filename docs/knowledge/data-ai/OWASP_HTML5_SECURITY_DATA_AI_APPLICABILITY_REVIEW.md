# OWASP HTML5 Security Data and AI Applicability Review

## Purpose

Evaluate whether current **HTML5 Security** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
