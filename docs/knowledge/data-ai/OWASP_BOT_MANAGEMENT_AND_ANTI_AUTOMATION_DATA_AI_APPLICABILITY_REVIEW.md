# OWASP Bot Management and Anti-Automation Data and AI Applicability Review

## Purpose

Evaluate whether current **Bot Management and Anti-Automation** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
