# OWASP SQL Injection Prevention Data and AI Applicability Review

## Purpose

Evaluate whether current **SQL Injection Prevention** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
