# OWASP JSON Web Token Data and AI Applicability Review

## Purpose

Evaluate whether current **JSON Web Token** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
