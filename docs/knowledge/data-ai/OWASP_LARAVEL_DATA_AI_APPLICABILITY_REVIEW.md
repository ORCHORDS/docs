# OWASP Laravel Data and AI Applicability Review

## Purpose

Evaluate whether current **Laravel** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
