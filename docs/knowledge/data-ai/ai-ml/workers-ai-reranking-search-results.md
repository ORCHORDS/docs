...
- `documentation/docs/policies/ai-ml/workers-ai-function-calling-tool-use.md` — use search results as tool output
- `documentation/docs/policies/ai-ml/workers-ai-prompt-caching-kv.md` — cache reranked results
