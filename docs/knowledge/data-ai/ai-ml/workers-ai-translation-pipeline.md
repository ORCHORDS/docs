...
- `documentation/docs/policies/ai-ml/workers-ai-prompt-caching-kv.md` — KV caching patterns
- `documentation/docs/policies/ai-ml/workers-ai-structured-output.md` — language detection via structured output
