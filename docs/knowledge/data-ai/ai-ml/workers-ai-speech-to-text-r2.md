...
- `documentation/docs/policies/ai-ml/workers-ai-multimodal-image-analysis.md` — similar R2-backed async analysis pattern.
- `documentation/docs/policies/ai-ml/workers-ai-batch-embedding-pipeline.md` — embed transcripts for semantic search.
