...
- `documentation/docs/policies/ai-ml/workers-ai-content-moderation.md` — combining sentiment with safety classification
- `documentation/docs/policies/ai-ml/workers-ai-structured-output.md` — detailed aspect-based sentiment via LLM JSON mode
- `documentation/docs/policies/ai-ml/workers-ai-rag-pipeline.md` — retrieving sentiment context for personalization
