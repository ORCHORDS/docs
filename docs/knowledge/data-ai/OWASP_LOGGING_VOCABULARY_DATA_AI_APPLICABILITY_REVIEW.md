# OWASP Logging Vocabulary Data and AI Applicability Review

## Purpose

Evaluate whether current **Logging Vocabulary** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
