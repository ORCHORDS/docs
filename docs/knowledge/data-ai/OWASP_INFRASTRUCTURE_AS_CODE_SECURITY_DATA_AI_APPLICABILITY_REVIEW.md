# OWASP Infrastructure as Code Security Data and AI Applicability Review

## Purpose

Evaluate whether current **Infrastructure as Code Security** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
