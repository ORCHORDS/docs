# OWASP Injection Prevention in Java Data and AI Applicability Review

## Purpose

Evaluate whether current **Injection Prevention in Java** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
