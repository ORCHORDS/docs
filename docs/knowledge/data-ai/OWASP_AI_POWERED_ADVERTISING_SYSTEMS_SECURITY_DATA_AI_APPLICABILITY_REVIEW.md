# OWASP AI-Powered Advertising Systems Security Data and AI Applicability Review

## Purpose

Evaluate whether current **AI-Powered Advertising Systems Security** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
