# OWASP Microservices based Security Arch Doc Data and AI Applicability Review

## Purpose

Evaluate whether current **Microservices based Security Arch Doc** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
