# OWASP Cross Site Scripting Prevention Data and AI Applicability Review

## Purpose

Evaluate whether current **Cross Site Scripting Prevention** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
