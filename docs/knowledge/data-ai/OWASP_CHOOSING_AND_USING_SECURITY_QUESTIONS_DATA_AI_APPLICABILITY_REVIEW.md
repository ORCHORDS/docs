# OWASP Choosing and Using Security Questions Data and AI Applicability Review

## Purpose

Evaluate whether current **Choosing and Using Security Questions** guidance creates requirements for a data or AI system, including data pipelines, model services, retrieval components, agents, automation, and supporting APIs.
