# AML Sanctions AI Agent Payments: Treat It as an Explicit Review Surface

## Lesson

Security concerns represented by **AML Sanctions AI Agent Payments** should not be left to implicit assumptions when the topic is relevant. Make applicability an explicit design, implementation, or operational review decision and verify the resulting behavior.
...
Official OWASP Cheat Sheet Series guidance: https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/AML_Sanctions_AI_Agent_Payments_Cheat_Sheet.md
