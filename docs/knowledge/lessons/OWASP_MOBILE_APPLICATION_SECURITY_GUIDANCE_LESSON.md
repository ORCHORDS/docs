# Mobile Application Security: Treat It as an Explicit Review Surface

## Lesson

Security concerns represented by **Mobile Application Security** should not be left to implicit assumptions when the topic is relevant. Make applicability an explicit design, implementation, or operational review decision and verify the resulting behavior.
...
Official OWASP Cheat Sheet Series guidance: https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Mobile_Application_Security_Cheat_Sheet.md
