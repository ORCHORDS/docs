...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/agent-context-engineering-2026.md` and `documentation/docs/policies/patterns/structured-output-2026.md`.
...
- `documentation/docs/policies/patterns/agent-context-engineering-2026.md` — context window as RAM
- `documentation/docs/policies/patterns/structured-output-2026.md` — guaranteed schema compliance
- `documentation/docs/policies/patterns/prompt-caching-2026.md` — the cost lever
- `documentation/docs/policies/lessons/agent-iteration-discipline.md` — the eval-driven loop
- `documentation/docs/policies/lessons/llm-as-judge-calibration-2026.md` — measuring prompt quality
