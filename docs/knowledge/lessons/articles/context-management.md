...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/agent-context-engineering-2026.md`.
...
- `documentation/docs/policies/patterns/agent-context-engineering-2026.md` — the broader pattern
- `documentation/docs/policies/patterns/prompt-caching-2026.md` — caching is the cost lever for context-heavy prompts
- `documentation/docs/policies/patterns/agent-memory-2026.md` — long-term memory platforms
- `documentation/docs/policies/lessons/agent-self-correction.md` — reflection fits inside the context window
- `documentation/docs/policies/cloudflare/sandbox-2026.md` — sub-agent delegation pattern via sandboxes
