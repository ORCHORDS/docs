...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/docs/policies/patterns/agent-eval-2026.md` and `documentation/docs/policies/lessons/eval-driven-development-2026.md`.
...
- `documentation/docs/policies/patterns/agent-eval-2026.md` — the four dimensions of agent quality
- `documentation/docs/policies/lessons/eval-driven-development-2026.md` — the eval-as-deploy-gate loop
- `documentation/docs/policies/lessons/prompt-engineering-2026.md` — rubric design is a prompt problem
