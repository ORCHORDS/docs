...
**Source:** This repo:
- `documentation/docs/policies/lessons/lazy-fail-discoveries.md` — the L1-L5 rules
- `documentation/docs/policies/lessons/lazy-fail-evidence-discipline.md` — the evidence rules
...
## Related
- `documentation/docs/policies/lessons/lazy-fail-discoveries.md` — the L1-L5 rules this entry synthesizes
- `documentation/docs/policies/lessons/lazy-fail-evidence-discipline.md` — the evidence rules
- `documentation/docs/policies/lessons/scope-discipline.md` — applies to iteration: one PR = one concern
- `documentation/docs/policies/lessons/user-pivot-rule.md` — user approval for destructive ops
- `documentation/docs/policies/lessons/when-to-ask-vs-push.md` — push on reversible, ask on irreversible
- `documentation/docs/policies/lessons/example project-audit-2026-08.md` — the 30 real findings that the eval suite should catch
- `documentation/docs/policies/patterns/agent-skill-design.md` — SKILL.md design
- `documentation/docs/policies/patterns/mcp-server-patterns.md` — MCP tool design (eval applies to tools too)
