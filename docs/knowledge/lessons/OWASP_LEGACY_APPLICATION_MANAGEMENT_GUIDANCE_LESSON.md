# Legacy Application Management: Treat It as an Explicit Review Surface

## Lesson

Security concerns represented by **Legacy Application Management** should not be left to implicit assumptions when the topic is relevant. Make applicability an explicit design, implementation, or operational review decision and verify the resulting behavior.
...
Official OWASP Cheat Sheet Series guidance: https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Legacy_Application_Management_Cheat_Sheet.md
