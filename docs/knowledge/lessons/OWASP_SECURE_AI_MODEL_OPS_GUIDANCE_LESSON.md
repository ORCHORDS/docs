# Secure AI Model Ops: Treat It as an Explicit Review Surface

## Lesson

Security concerns represented by **Secure AI Model Ops** should not be left to implicit assumptions when the topic is relevant. Make applicability an explicit design, implementation, or operational review decision and verify the resulting behavior.
...
Official OWASP Cheat Sheet Series guidance: https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Secure_AI_Model_Ops_Cheat_Sheet.md
