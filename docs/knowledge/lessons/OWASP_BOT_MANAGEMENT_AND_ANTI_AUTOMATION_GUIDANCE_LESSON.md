# Bot Management and Anti-Automation: Treat It as an Explicit Review Surface

## Lesson

Security concerns represented by **Bot Management and Anti-Automation** should not be left to implicit assumptions when the topic is relevant. Make applicability an explicit design, implementation, or operational review decision and verify the resulting behavior.
...
Official OWASP Cheat Sheet Series guidance: https://github.com/OWASP/CheatSheetSeries/blob/master/cheatsheets/Bot_Management_and_Anti-Automation_Cheat_Sheet.md
