# OWASP Multi Tenant Security Adoption Verification Playbook

## Objective

Use the current OWASP **Multi Tenant Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
