# OWASP Server Side Request Forgery Prevention Adoption Verification Playbook

## Objective

Use the current OWASP **Server Side Request Forgery Prevention** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
