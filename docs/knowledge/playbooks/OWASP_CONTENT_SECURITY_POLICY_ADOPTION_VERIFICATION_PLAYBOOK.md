# OWASP Content Security Policy Adoption Verification Playbook

## Objective

Use the current OWASP **Content Security Policy** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
