# OWASP Forgot Password Adoption Verification Playbook

## Objective

Use the current OWASP **Forgot Password** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
