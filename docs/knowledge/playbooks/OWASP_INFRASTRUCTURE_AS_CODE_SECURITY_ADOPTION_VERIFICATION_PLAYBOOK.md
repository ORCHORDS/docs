# OWASP Infrastructure as Code Security Adoption Verification Playbook

## Objective

Use the current OWASP **Infrastructure as Code Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
