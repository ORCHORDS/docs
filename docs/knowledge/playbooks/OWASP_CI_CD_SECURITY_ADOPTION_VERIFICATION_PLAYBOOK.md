# OWASP CI CD Security Adoption Verification Playbook

## Objective

Use the current OWASP **CI CD Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
