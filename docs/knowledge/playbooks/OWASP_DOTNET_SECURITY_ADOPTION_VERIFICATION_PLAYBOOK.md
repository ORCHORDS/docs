# OWASP DotNet Security Adoption Verification Playbook

## Objective

Use the current OWASP **DotNet Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
