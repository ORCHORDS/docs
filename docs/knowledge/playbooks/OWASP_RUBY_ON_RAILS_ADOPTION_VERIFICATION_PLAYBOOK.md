# OWASP Ruby on Rails Adoption Verification Playbook

## Objective

Use the current OWASP **Ruby on Rails** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
