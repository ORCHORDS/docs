# OWASP Software Supply Chain Security Adoption Verification Playbook

## Objective

Use the current OWASP **Software Supply Chain Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
