# OWASP SAML Security Adoption Verification Playbook

## Objective

Use the current OWASP **SAML Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
