# OWASP Multifactor Authentication Adoption Verification Playbook

## Objective

Use the current OWASP **Multifactor Authentication** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
