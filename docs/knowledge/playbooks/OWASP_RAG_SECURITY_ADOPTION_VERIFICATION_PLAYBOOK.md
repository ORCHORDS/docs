# OWASP RAG Security Adoption Verification Playbook

## Objective

Use the current OWASP **RAG Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
