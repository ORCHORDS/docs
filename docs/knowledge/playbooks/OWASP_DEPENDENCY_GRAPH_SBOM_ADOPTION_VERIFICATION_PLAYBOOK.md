# OWASP Dependency Graph SBOM Adoption Verification Playbook

## Objective

Use the current OWASP **Dependency Graph SBOM** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
