# OWASP Microservices Security Adoption Verification Playbook

## Objective

Use the current OWASP **Microservices Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
