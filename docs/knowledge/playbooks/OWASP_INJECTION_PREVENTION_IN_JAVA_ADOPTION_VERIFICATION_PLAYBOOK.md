# OWASP Injection Prevention in Java Adoption Verification Playbook

## Objective

Use the current OWASP **Injection Prevention in Java** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
