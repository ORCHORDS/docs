# OWASP DOM based XSS Prevention Adoption Verification Playbook

## Objective

Use the current OWASP **DOM based XSS Prevention** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
