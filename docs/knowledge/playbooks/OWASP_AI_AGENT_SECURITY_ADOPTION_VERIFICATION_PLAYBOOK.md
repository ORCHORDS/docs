# OWASP AI Agent Security Adoption Verification Playbook

## Objective

Use the current OWASP **AI Agent Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
