# OWASP Serverless FaaS Security Adoption Verification Playbook

## Objective

Use the current OWASP **Serverless FaaS Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
