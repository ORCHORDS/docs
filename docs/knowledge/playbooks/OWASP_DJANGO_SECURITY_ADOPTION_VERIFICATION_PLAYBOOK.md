# OWASP Django Security Adoption Verification Playbook

## Objective

Use the current OWASP **Django Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
