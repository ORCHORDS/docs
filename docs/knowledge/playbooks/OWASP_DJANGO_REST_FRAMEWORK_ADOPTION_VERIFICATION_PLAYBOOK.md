# OWASP Django REST Framework Adoption Verification Playbook

## Objective

Use the current OWASP **Django REST Framework** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
