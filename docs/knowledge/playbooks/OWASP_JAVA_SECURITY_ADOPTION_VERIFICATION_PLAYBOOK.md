# OWASP Java Security Adoption Verification Playbook

## Objective

Use the current OWASP **Java Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
