# OWASP HTML5 Security Adoption Verification Playbook

## Objective

Use the current OWASP **HTML5 Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
