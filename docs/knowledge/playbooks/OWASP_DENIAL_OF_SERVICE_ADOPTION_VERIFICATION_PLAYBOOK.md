# OWASP Denial of Service Adoption Verification Playbook

## Objective

Use the current OWASP **Denial of Service** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
