# OWASP Security Terminology Adoption Verification Playbook

## Objective

Use the current OWASP **Security Terminology** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
