# OWASP JSON Web Token Adoption Verification Playbook

## Objective

Use the current OWASP **JSON Web Token** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
