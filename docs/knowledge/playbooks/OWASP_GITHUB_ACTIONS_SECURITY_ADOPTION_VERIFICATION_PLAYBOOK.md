# OWASP GitHub Actions Security Adoption Verification Playbook

## Objective

Use the current OWASP **GitHub Actions Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
