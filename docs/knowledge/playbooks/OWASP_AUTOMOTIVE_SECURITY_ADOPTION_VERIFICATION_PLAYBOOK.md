# OWASP Automotive Security Adoption Verification Playbook

## Objective

Use the current OWASP **Automotive Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
