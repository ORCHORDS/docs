# OWASP REST Assessment Adoption Verification Playbook

## Objective

Use the current OWASP **REST Assessment** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
