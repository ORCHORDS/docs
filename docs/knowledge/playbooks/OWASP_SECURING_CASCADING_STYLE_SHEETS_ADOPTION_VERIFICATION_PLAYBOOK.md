# OWASP Securing Cascading Style Sheets Adoption Verification Playbook

## Objective

Use the current OWASP **Securing Cascading Style Sheets** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
