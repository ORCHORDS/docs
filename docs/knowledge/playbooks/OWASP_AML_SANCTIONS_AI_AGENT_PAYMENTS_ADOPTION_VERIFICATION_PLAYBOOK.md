# OWASP AML Sanctions AI Agent Payments Adoption Verification Playbook

## Objective

Use the current OWASP **AML Sanctions AI Agent Payments** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
