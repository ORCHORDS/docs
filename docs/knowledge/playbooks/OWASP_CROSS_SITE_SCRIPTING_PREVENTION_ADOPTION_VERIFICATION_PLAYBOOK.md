# OWASP Cross Site Scripting Prevention Adoption Verification Playbook

## Objective

Use the current OWASP **Cross Site Scripting Prevention** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
