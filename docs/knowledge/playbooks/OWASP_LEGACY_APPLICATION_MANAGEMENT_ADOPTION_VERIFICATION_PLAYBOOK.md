# OWASP Legacy Application Management Adoption Verification Playbook

## Objective

Use the current OWASP **Legacy Application Management** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
