# OWASP Secure Coding with AI Adoption Verification Playbook

## Objective

Use the current OWASP **Secure Coding with AI** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
