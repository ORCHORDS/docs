# OWASP NPM Security Adoption Verification Playbook

## Objective

Use the current OWASP **NPM Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
