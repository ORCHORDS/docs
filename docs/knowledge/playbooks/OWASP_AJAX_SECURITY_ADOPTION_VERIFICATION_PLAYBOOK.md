# OWASP AJAX Security Adoption Verification Playbook

## Objective

Use the current OWASP **AJAX Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
