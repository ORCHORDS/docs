# OWASP HTTP Strict Transport Security Adoption Verification Playbook

## Objective

Use the current OWASP **HTTP Strict Transport Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
