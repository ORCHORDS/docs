# OWASP REST Security Adoption Verification Playbook

## Objective

Use the current OWASP **REST Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
