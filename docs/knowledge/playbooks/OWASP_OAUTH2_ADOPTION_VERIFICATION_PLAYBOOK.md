# OWASP OAuth2 Adoption Verification Playbook

## Objective

Use the current OWASP **OAuth2** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
