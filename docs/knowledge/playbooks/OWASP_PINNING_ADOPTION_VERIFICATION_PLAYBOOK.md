# OWASP Pinning Adoption Verification Playbook

## Objective

Use the current OWASP **Pinning** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
