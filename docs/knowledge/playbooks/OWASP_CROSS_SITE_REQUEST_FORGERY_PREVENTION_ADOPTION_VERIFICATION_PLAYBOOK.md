# OWASP Cross-Site Request Forgery Prevention Adoption Verification Playbook

## Objective

Use the current OWASP **Cross-Site Request Forgery Prevention** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
