# OWASP Mobile Application Security Adoption Verification Playbook

## Objective

Use the current OWASP **Mobile Application Security** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
