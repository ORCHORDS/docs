# OWASP Secure Product Design Adoption Verification Playbook

## Objective

Use the current OWASP **Secure Product Design** guidance to perform a repeatable, evidence-based adoption or re-verification cycle.
