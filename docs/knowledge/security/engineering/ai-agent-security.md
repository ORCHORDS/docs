...
- `documentation/docs/policies/security/prompt-injection-defense.md` — input-side defenses (this entry covers output, tool, memory, and inter-agent)
- `documentation/docs/policies/security/owasp-top-10-2025.md` — the LLM (non-agentic) catalog
- `documentation/docs/policies/security/owasp-api-top-10-2023.md` — the API layer underneath
- `documentation/docs/policies/security/silent-catch-antipattern.md` — why a `try { } catch {}` on tool output is dangerous here
- `documentation/docs/policies/patterns/secure-defaults.md` — least-privilege defaults at deployment
- `documentation/docs/policies/patterns/multi-agent-orchestration.md` — where the deterministic validation gate lives
- `documentation/docs/policies/lessons/agent-self-correction.md` — self-correction does not catch injection (different problem)
