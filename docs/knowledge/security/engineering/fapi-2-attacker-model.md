...
This document defines attacker capabilities and security goals, not wire syntax. Model web attackers, malicious endpoints, compromised components, browser and network channels, and leaked codes, access tokens, refresh tokens or credentials. For each message record sender authentication, intended audience, integrity, confidentiality, freshness and replay controls.
...
- [Canonical specification](https://openid.net/specs/fapi-2_0-attacker-model-final.html)
