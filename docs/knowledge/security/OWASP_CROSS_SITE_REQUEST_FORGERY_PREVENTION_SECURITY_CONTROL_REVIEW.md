# OWASP Cross-Site Request Forgery Prevention Security Control Review

## Purpose

Use this review to determine which current OWASP **Cross-Site Request Forgery Prevention** guidance is applicable to a concrete security scope and what evidence is needed to show the resulting controls actually work.
