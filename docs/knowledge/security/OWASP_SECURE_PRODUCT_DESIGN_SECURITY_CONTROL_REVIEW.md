# OWASP Secure Product Design Security Control Review

## Purpose

Use this review to determine which current OWASP **Secure Product Design** guidance is applicable to a concrete security scope and what evidence is needed to show the resulting controls actually work.
