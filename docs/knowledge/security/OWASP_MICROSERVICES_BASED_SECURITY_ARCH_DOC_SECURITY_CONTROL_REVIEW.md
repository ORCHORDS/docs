# OWASP Microservices based Security Arch Doc Security Control Review

## Purpose

Use this review to determine which current OWASP **Microservices based Security Arch Doc** guidance is applicable to a concrete security scope and what evidence is needed to show the resulting controls actually work.
