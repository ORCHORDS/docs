# OWASP Attack Surface Analysis Security Control Review

## Purpose

Use this review to determine which current OWASP **Attack Surface Analysis** guidance is applicable to a concrete security scope and what evidence is needed to show the resulting controls actually work.
