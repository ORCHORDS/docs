# OWASP Choosing and Using Security Questions Security Control Review

## Purpose

Use this review to determine which current OWASP **Choosing and Using Security Questions** guidance is applicable to a concrete security scope and what evidence is needed to show the resulting controls actually work.
