# OWASP Cross Site Scripting Prevention Operationalization Review

## Purpose

Turn applicable **Cross Site Scripting Prevention** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
