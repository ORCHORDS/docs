# OWASP GitHub Actions Security Operationalization Review

## Purpose

Turn applicable **GitHub Actions Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
