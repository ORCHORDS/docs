# OWASP DotNet Security Operationalization Review

## Purpose

Turn applicable **DotNet Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
