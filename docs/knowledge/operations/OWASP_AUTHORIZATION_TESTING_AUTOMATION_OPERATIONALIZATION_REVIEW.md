# OWASP Authorization Testing Automation Operationalization Review

## Purpose

Turn applicable **Authorization Testing Automation** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
