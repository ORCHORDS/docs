# OWASP Database Security Operationalization Review

## Purpose

Turn applicable **Database Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
