# OWASP HTTP Headers Operationalization Review

## Purpose

Turn applicable **HTTP Headers** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
