# OWASP Microservices Security Operationalization Review

## Purpose

Turn applicable **Microservices Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
