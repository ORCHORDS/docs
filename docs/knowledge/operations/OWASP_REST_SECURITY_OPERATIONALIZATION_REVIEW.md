# OWASP REST Security Operationalization Review

## Purpose

Turn applicable **REST Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
