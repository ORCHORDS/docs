# OWASP SAML Security Operationalization Review

## Purpose

Turn applicable **SAML Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
