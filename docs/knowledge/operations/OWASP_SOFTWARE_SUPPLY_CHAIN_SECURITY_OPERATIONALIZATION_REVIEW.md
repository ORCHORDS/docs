# OWASP Software Supply Chain Security Operationalization Review

## Purpose

Turn applicable **Software Supply Chain Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
