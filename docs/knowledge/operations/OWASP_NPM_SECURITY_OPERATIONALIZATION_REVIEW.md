# OWASP NPM Security Operationalization Review

## Purpose

Turn applicable **NPM Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
