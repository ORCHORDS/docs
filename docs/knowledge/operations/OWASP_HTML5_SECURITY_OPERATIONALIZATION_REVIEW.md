# OWASP HTML5 Security Operationalization Review

## Purpose

Turn applicable **HTML5 Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
