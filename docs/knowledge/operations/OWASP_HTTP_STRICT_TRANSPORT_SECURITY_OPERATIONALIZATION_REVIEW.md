# OWASP HTTP Strict Transport Security Operationalization Review

## Purpose

Turn applicable **HTTP Strict Transport Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
