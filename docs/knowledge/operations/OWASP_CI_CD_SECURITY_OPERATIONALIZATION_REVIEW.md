# OWASP CI CD Security Operationalization Review

## Purpose

Turn applicable **CI CD Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
