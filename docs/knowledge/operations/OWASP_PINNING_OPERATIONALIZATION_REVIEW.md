# OWASP Pinning Operationalization Review

## Purpose

Turn applicable **Pinning** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
