# OWASP OAuth2 Operationalization Review

## Purpose

Turn applicable **OAuth2** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
