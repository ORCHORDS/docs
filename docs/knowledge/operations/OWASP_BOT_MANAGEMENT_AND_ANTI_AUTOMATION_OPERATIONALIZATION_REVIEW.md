# OWASP Bot Management and Anti-Automation Operationalization Review

## Purpose

Turn applicable **Bot Management and Anti-Automation** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
