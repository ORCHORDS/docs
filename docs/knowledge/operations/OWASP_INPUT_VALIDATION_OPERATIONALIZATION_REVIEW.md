# OWASP Input Validation Operationalization Review

## Purpose

Turn applicable **Input Validation** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
