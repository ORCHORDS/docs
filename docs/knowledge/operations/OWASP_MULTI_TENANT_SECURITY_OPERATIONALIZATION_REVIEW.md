# OWASP Multi Tenant Security Operationalization Review

## Purpose

Turn applicable **Multi Tenant Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
