# OWASP NoSQL Security Operationalization Review

## Purpose

Turn applicable **NoSQL Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
