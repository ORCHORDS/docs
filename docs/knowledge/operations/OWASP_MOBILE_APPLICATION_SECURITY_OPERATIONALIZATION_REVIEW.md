# OWASP Mobile Application Security Operationalization Review

## Purpose

Turn applicable **Mobile Application Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
