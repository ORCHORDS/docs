# OWASP NodeJS Docker Operationalization Review

## Purpose

Turn applicable **NodeJS Docker** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
