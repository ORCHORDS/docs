# OWASP AJAX Security Operationalization Review

## Purpose

Turn applicable **AJAX Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
