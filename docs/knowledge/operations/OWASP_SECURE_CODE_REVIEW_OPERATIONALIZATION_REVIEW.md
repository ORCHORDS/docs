# OWASP Secure Code Review Operationalization Review

## Purpose

Turn applicable **Secure Code Review** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
