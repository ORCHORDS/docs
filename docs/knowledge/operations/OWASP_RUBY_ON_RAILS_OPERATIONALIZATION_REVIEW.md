# OWASP Ruby on Rails Operationalization Review

## Purpose

Turn applicable **Ruby on Rails** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
