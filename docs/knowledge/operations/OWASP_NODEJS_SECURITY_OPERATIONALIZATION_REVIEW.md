# OWASP Nodejs Security Operationalization Review

## Purpose

Turn applicable **Nodejs Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
