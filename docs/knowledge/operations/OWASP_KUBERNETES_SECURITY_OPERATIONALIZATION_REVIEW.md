# OWASP Kubernetes Security Operationalization Review

## Purpose

Turn applicable **Kubernetes Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
