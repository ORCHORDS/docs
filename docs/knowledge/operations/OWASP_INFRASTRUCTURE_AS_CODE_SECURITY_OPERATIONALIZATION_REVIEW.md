# OWASP Infrastructure as Code Security Operationalization Review

## Purpose

Turn applicable **Infrastructure as Code Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
