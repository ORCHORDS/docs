# OWASP Authorization Operationalization Review

## Purpose

Turn applicable **Authorization** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
