# OWASP Network Segmentation Operationalization Review

## Purpose

Turn applicable **Network Segmentation** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
