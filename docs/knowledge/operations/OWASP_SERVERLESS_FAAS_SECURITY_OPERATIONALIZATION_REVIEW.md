# OWASP Serverless FaaS Security Operationalization Review

## Purpose

Turn applicable **Serverless FaaS Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
