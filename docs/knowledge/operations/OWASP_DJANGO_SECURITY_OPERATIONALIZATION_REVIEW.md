# OWASP Django Security Operationalization Review

## Purpose

Turn applicable **Django Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
