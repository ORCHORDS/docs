...
- `documentation/docs/policies/deploy/workers-zero-downtime-d1-migration.md` — running migrations as part of the deployment pipeline
- `documentation/docs/policies/deploy/workers-version-pinning-gradual-rollout.md` — gradual traffic rollout after approval
- `documentation/docs/policies/deploy/workers-secrets-rotation-automation.md` — secret rotation triggered post-deploy
