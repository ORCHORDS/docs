# OWASP Drone Security Operationalization Review

## Purpose

Turn applicable **Drone Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
