# OWASP JSON Web Token Operationalization Review

## Purpose

Turn applicable **JSON Web Token** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
