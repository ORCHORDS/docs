# OWASP DOM based XSS Prevention Operationalization Review

## Purpose

Turn applicable **DOM based XSS Prevention** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
