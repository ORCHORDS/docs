# Linux open_tree mount-cloning boundary

**Problem**

Descriptor-based mount-tree cloning is race-resistant but has powerful namespace effects.
...
- [Official documentation](https://man7.org/linux/man-pages/man2/open_tree.2.html)
