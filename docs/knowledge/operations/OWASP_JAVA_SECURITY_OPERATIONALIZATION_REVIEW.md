# OWASP Java Security Operationalization Review

## Purpose

Turn applicable **Java Security** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
