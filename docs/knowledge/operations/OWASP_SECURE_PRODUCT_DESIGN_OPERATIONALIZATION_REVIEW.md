# OWASP Secure Product Design Operationalization Review

## Purpose

Turn applicable **Secure Product Design** security guidance into repeatable operating practices, monitoring, response, and maintenance activities.
