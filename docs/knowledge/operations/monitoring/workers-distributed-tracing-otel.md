...
- `documentation/docs/policies/monitoring/workers-log-sampling-strategy.md` — sampling policies
- `documentation/docs/policies/monitoring/synthetic-monitoring-playwright.md` — end-to-end traces
- `documentation/docs/policies/monitoring/cost-per-request-tracking.md` — span-level cost attribution
