...
- `documentation/docs/policies/monitoring/on-call-rotation-pagerduty.md` — alert routing and escalation
- `documentation/docs/policies/monitoring/metric-aggregation-cron-d1.md` — metric ingestion
- `documentation/docs/policies/monitoring/cost-per-request-tracking.md` — per-request cost in the SLO context
