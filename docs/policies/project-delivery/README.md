---
title: "Project and Delivery Governance"
owner: "Delivery Lead"
status: "approved"
...
Company-wide governance for initiating, planning, steering, changing, accepting, handing over, and closing projects.

## Documents

- [Project Governance](PROJECT_GOVERNANCE.md)
- [Project Sponsorship Governance](PROJECT_SPONSORSHIP_GOVERNANCE.md)
- [Project Sponsor Recertification](PROJECT_SPONSOR_RECERTIFICATION.md)
- [Project Initiation](PROJECT_INITIATION.md)
- [Project Scope Baseline](PROJECT_SCOPE_BASELINE.md)
...
- [Project Assumption Recertification](PROJECT_ASSUMPTION_RECERTIFICATION.md)
...
- [Milestone Recertification](MILESTONE_RECERTIFICATION.md)
- [Stage Gate Governance](STAGE_GATE_GOVERNANCE.md)
- [Project Risk, Issue, and Change](PROJECT_RISK_ISSUE_CHANGE.md)
- [Project Exception Aging](PROJECT_EXCEPTION_AGING.md)
- [Project Change Impact Assessment](PROJECT_CHANGE_IMPACT.md)
- [Project Dependency Management](DEPENDENCY_MANAGEMENT.md)
- [Portfolio Dependency Governance](PORTFOLIO_DEPENDENCY_GOVERNANCE.md)
...
- [Benefit Assumption Review](BENEFIT_ASSUMPTION_REVIEW.md)
