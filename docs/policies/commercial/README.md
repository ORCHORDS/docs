...
Company-wide rules for qualification, proposals, customer commitments, pilots, pricing, forecasts, renewals, assurance responses, partners, and handover into delivery.
...
- [Customer Requirement Recertification](CUSTOMER_REQUIREMENT_RECERTIFICATION.md)
...
- [Commercial Exception Expiry](COMMERCIAL_EXCEPTION_EXPIRY.md)
- [Commercial Exception Aging](COMMERCIAL_EXCEPTION_AGING.md)
- [Proposal and Claim Accuracy](PROPOSAL_CLAIM_ACCURACY.md)
- [Proposal Version Control](PROPOSAL_VERSION_CONTROL.md)
- [Proposal Commitment Recertification](PROPOSAL_COMMITMENT_RECERTIFICATION.md)
...
- [Pilot Obligation Review](PILOT_OBLIGATION_REVIEW.md)
...
- [Discount Exception Evidence](DISCOUNT_EXCEPTION_EVIDENCE.md)
- [Commercial Forecast Integrity](FORECAST_INTEGRITY.md)
- [Commercial Forecast Assumption Governance](FORECAST_ASSUMPTION_GOVERNANCE.md)
- [Forecast Bias Review](FORECAST_BIAS_REVIEW.md)
- [Commercial Renewal Governance](RENEWAL_COMMERCIAL_GOVERNANCE.md)
- [Customer Assurance Responses](CUSTOMER_ASSURANCE_RESPONSES.md)
- [Customer Reference Governance](CUSTOMER_REFERENCE_GOVERNANCE.md)
- [Commercial Partner and Channel Governance](PARTNER_CHANNEL_GOVERNANCE.md)
- [Partner Commitment Traceability](PARTNER_COMMITMENT_TRACEABILITY.md)
- [Commercial Data Quality](COMMERCIAL_DATA_QUALITY.md)
