...
[Policy Hierarchy](./categories/governance/POLICY_HIERARCHY.md) and
[Corporate Governance](./categories/governance/GOVERNANCE.md).
...
3. Standards status follows
   [Framework Status Policy](./categories/standards/FRAMEWORK_STATUS_POLICY.md):
...
[Document Control](./categories/governance/DOCUMENT_CONTROL.md), and
`scripts/check_docs.py` enforces it on every change.
