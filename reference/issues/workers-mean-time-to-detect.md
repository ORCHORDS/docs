...
- `documentation/categories/issues/workers-incident-timeline-reconstruction.md` — correlates alert timestamps with deploy events
- `documentation/categories/issues/workers-error-budget-tracker.md` — consumes MTTD data for SLO burn-rate calculations
- `documentation/categories/issues/workers-alert-correlation-dedup.md` — upstream dedup pipeline that feeds this ingest endpoint
- `documentation/categories/issues/workers-sla-breach-auto-escalation.md` — downstream escalation triggered when MTTD exceeds SLA threshold
