...
- `documentation/categories/issues/workers-sla-breach-auto-escalation.md` — feeds SLA risk data into handoff summaries
- `documentation/categories/issues/workers-incident-response-bot.md` — incident records queried during handoff summary generation
- `documentation/categories/issues/workers-error-budget-tracker.md` — populates the `slo_status` table consumed here
- `documentation/categories/issues/workers-alert-correlation-dedup.md` — alert records in the 24-hour window displayed in handoff
