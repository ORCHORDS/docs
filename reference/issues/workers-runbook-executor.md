...
- `documentation/categories/issues/workers-alert-correlation-dedup.md` — canonical incident creation triggers runbook execution
- `documentation/categories/issues/workers-incident-response-bot.md` — coordinates with runbook executor during incident lifecycle
- `documentation/categories/issues/workers-incident-timeline-reconstruction.md` — runbook step execution events are ingested as timeline events
- `documentation/categories/issues/workers-on-call-handoff-bot.md` — execution logs in R2 are linked in handoff summaries for unresolved runbooks
