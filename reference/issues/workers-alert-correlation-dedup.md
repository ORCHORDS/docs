...
- `documentation/categories/issues/workers-mean-time-to-detect.md` — consumes deduplicated alert events for MTTD calculation
- `documentation/categories/issues/workers-on-call-handoff-bot.md` — handoff summary shows alert counts from the dedup pipeline
- `documentation/categories/issues/workers-sla-breach-auto-escalation.md` — canonical incidents trigger SLA breach evaluation
- `documentation/categories/issues/workers-runbook-executor.md` — canonical incident creation triggers automated runbook execution
