...
- `documentation/categories/ai-ml/workers-ai-prompt-caching-kv.md` — cache completed responses to avoid repeat inference.
- `documentation/categories/ai-ml/workers-ai-function-calling-tools.md` — structured outputs that pair with streaming.
