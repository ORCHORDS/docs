...
- `documentation/categories/ai-ml/workers-ai-function-calling-tool-use.md` — pass transcript to an agent
- `documentation/categories/ai-ml/workers-ai-image-generation-flux.md` — async Queue pattern
