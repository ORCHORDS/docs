...
- `documentation/categories/ai-ml/workers-ai-structured-output.md` — structured classification output pattern
- `documentation/categories/ai-ml/workers-ai-sentiment-analysis.md` — scoring pipeline with Analytics Engine
