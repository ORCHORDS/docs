...
- `documentation/categories/ai-ml/workers-ai-rag-vectorize-d1.md` — using the Vectorize index for semantic search / RAG.
- `documentation/categories/ai-ml/workers-ai-streaming-text-generation.md` — streaming inference at query time.
