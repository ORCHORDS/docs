...
- `documentation/categories/ai-ml/workers-ai-prompt-caching-kv.md` — cache repeated tool results
- `documentation/categories/ai-ml/workers-ai-reranking-search-results.md` — rerank before passing results to tool
