...
- `documentation/categories/ai-ml/workers-ai-function-calling-tool-use.md` — cache tool result messages
- `documentation/categories/ai-ml/workers-ai-reranking-search-results.md` — cache reranker scores
