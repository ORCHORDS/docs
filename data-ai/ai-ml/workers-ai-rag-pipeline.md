...
- `documentation/categories/ai-ml/workers-embeddings-vectorize.md` — embeddings and Vectorize fundamentals
- `documentation/categories/ai-ml/workers-ai-structured-output.md` — structured extraction from retrieved content
- `documentation/categories/ai-ml/workers-ai-prompt-caching-kv.md` — KV caching for repeated queries
