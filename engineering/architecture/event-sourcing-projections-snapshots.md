...
- `documentation/categories/architecture/event-sourcing-cqrs-patterns.md`
- `documentation/categories/architecture/saga-pattern-orchestration-choreography.md`
- `documentation/categories/patterns/outbox-pattern-reliable-messaging.md`
