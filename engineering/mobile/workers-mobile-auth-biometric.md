...
- `documentation/categories/mobile/workers-session-refresh-token-rotation.md` — access/refresh token lifecycle
- `documentation/categories/mobile/push-notification-fcm-apns.md` — device registration alongside credential registration
- `documentation/categories/mobile/device-detection.md` — platform detection for biometric capability checks
