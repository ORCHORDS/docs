...
- `documentation/categories/database/d1-full-text-search-fts5.md` — FTS5 over TEXT columns including JSON-derived values
- `documentation/categories/database/d1-schema-version-tracking.md` — adding expression indexes via migrations
- `documentation/categories/database/d1-row-level-security-pattern.md` — combining JSON column filters with tenant_id RLS
