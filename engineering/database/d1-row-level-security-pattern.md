...
- `documentation/categories/database/d1-schema-version-tracking.md` — adding tenant_id columns via migrations
- `documentation/categories/database/d1-json-column-queries.md` — JSON columns with tenant-scoped queries
- `documentation/categories/database/d1-full-text-search-fts5.md` — combining FTS MATCH with tenant_id filter
- `documentation/categories/database/d1-connection-pooling-hyperdrive-pattern.md` — RLS applies equally when switching to Postgres via Hyperdrive
