...
- `documentation/categories/database/d1-row-level-security-pattern.md` — RLS pattern applies equally to both D1 and Postgres paths
- `documentation/categories/database/d1-schema-version-tracking.md` — migration runner must target the active database backend
- `documentation/categories/database/d1-json-column-queries.md` — JSON functions differ between SQLite and Postgres (use `->>`/`@>` in Postgres)
