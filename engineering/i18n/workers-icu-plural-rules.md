...
- `documentation/categories/i18n/workers-currency-formatting-intl.md` — number formatting with locale-specific decimal/grouping separators
- `documentation/categories/i18n/workers-locale-negotiation.md` — selecting the right locale before looking up plural strings
- `documentation/categories/i18n/translation-import-export-d1.md` — importing plural-form catalogs from XLIFF/PO files into D1
