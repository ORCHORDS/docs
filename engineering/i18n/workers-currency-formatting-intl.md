...
- `documentation/categories/i18n/number-unit-formatting-intl.md` — non-currency number formatting (units, percentages, compact notation)
- `documentation/categories/i18n/workers-locale-negotiation.md` — determining the display locale per request
- `documentation/categories/i18n/workers-icu-plural-rules.md` — pluralising "1 item"/"2 items" in cart summaries
