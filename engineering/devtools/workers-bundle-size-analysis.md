...
- `documentation/categories/devtools/workers-wrangler-custom-builds.md` — esbuild configuration that produces the metafile
- `documentation/categories/devtools/workers-sourcemap-debugging.md` — source maps add to upload size; coordinate budgets
- `documentation/categories/devtools/workers-workerd-local-dev.md` — profile cold-start performance once size is optimized
