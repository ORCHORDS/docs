...
- `documentation/categories/frontend/workers-server-sent-events-stream.md` — push real-time flag change notifications to connected clients
- `documentation/categories/frontend/workers-a11y-header-injection.md` — combine a11y and feature-flag rewriting in a single HTMLRewriter chain
- `documentation/categories/frontend/html-minification-htmlrewriter.md` — another HTMLRewriter pattern to compose with this one
