...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/patterns/agent-cost-optimization.md` and `documentation/categories/patterns/multi-agent-orchestration.md`.
...
- `documentation/categories/patterns/agent-cost-optimization.md` — the four cost levers
- `documentation/categories/patterns/multi-agent-orchestration.md` — when to route between agents
- `documentation/categories/patterns/prompt-caching-2026.md` — caching as a routing-adjacent lever
- `documentation/categories/patterns/agent-eval-2026.md` — measuring routing quality
- `documentation/categories/cloudflare/ai-gateway-best-practices.md` — gateway-level routing
