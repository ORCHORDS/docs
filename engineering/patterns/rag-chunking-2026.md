...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/patterns/rag-architecture-2026.md`.
...
- `documentation/categories/patterns/rag-architecture-2026.md` — the broader RAG topology
- `documentation/categories/cloudflare/ai-search-2026.md` — managed RAG on Cloudflare
- `documentation/categories/cloudflare/vectorize-2026.md` — the vector store
- `documentation/categories/patterns/agent-eval-2026.md` — how to measure retrieval quality
- `documentation/categories/patterns/prompt-caching-2026.md` — caching makes Contextual Retrieval affordable
