...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/lessons/agent-self-correction.md` (memory vs reflection).
...
- `documentation/categories/lessons/agent-self-correction.md` — reflection (intra-task) vs memory (inter-task)
- `documentation/categories/patterns/agent-context-engineering-2026.md` — context window as working memory
- `documentation/categories/patterns/agent-cost-optimization.md` — memory is a cost lever
- `documentation/categories/cloudflare/vectorize-2026.md` — one possible vector backend for a memory platform
- `documentation/categories/patterns/multi-agent-orchestration.md` — shared memory across agents
