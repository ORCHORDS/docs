...
- `documentation/categories/patterns/agent-cost-optimization.md` — caching is one of four levers (caching, routing, batching, model tier)
- `documentation/categories/patterns/agent-context-engineering-2026.md` — what to put in the cached prefix vs the volatile suffix
- `documentation/categories/cloudflare/ai-gateway-best-practices.md` — Cloudflare AI Gateway's caching layer complements provider caching
- `documentation/categories/lessons/agent-self-correction.md` — self-correction can multiply the cost that caching helps amortize
