...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/patterns/agent-eval-2026.md` and `documentation/categories/patterns/agent-guardrails-2026.md`.
...
- `documentation/categories/patterns/agent-eval-2026.md` — measuring schema compliance over time
- `documentation/categories/patterns/agent-guardrails-2026.md` — Layer 4 (output filtering) includes schema validation
- `documentation/categories/patterns/prompt-caching-2026.md` — co-locating schemas in the cache
- `documentation/categories/patterns/agent-context-engineering-2026.md` — the broader context budget
- `documentation/categories/cloudflare/ai-search-2026.md` — `ai-search` returns structured output by default
