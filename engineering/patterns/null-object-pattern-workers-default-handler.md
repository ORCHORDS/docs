...
- `documentation/categories/patterns/dependency-injection.md`
- `documentation/categories/patterns/strategy-pattern-workers-kv.md`
...
- `documentation/categories/patterns/graceful-degradation.md`
