...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/categories/lessons/agent-iteration-discipline.md` and the existing `documentation/categories/patterns/e2e-testing-patterns.md`.
...
- `documentation/categories/patterns/e2e-testing-patterns.md` — pre-prod tests vs online evals
- `documentation/categories/patterns/observability-three-pillars.md` — metrics/logs/traces as the substrate
- `documentation/categories/patterns/distributed-tracing-otel.md` — OpenTelemetry-based tracing that all of these platforms ingest
- `documentation/categories/lessons/agent-iteration-discipline.md` — when to stop iterating
- `documentation/categories/patterns/agent-cost-optimization.md` — eval cost is part of total agent cost
