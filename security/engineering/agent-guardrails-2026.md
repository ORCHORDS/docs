...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/security/ai-agent-security.md` and `documentation/categories/security/prompt-injection-defense.md`.
...
- `documentation/categories/security/ai-agent-security.md` — the broader agentic threat model
- `documentation/categories/security/prompt-injection-defense.md` — input-side defenses
- `documentation/categories/security/owasp-top-10-2025.md` — the non-agentic OWASP catalog
- `documentation/categories/security/owasp-api-top-10-2023.md` — the API layer
- `documentation/categories/lessons/human-in-the-loop.md` — the escalation layer for blocked actions
