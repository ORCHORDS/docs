...
- **Author**: kb-batch-2
- **Status**: Active; supplements `documentation/categories/cloudflare/containers-best-practices.md`.
...
- `documentation/categories/cloudflare/containers-best-practices.md` — the underlying primitive
- `documentation/categories/cloudflare/agents-sdk-best-practices.md` — the SDK on top of Sandboxes
- `documentation/categories/cloudflare/browser-run-best-practices.md` — for browser-driven workflows
- `documentation/categories/cloudflare/r2-best-practices.md` — snapshot storage backend
- `documentation/categories/cloudflare/workers-resource-limits.md` — sandbox-side memory and CPU limits
- `documentation/categories/security/ai-agent-security.md` — Rule of Two applies to sandbox creds and egress
