...
- MailChannels requires DKIM to be configured on your sending domain; without it, deliverability is poor. See `documentation/categories/email/mailchannels-dkim-workers.md`.
...
- `documentation/categories/email/mailchannels-dkim-workers.md`
