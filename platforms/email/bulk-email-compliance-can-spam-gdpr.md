...
- `documentation/categories/email/can-spam-compliance.md`
- `documentation/categories/email/gdpr-email-consent.md`
- `documentation/categories/email/unsubscribe-handling-rfc.md`
- `documentation/categories/email/suppression-list-management.md`
- `documentation/categories/email/email-preference-center.md`
