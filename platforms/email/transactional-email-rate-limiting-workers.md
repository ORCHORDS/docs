...
- `documentation/categories/email/email-frequency-capping.md`
- `documentation/categories/email/notification-email-patterns.md`
- `documentation/categories/email/email-abuse-prevention.md`
- `documentation/categories/email/email-queue-architecture.md`
