...
- `documentation/categories/email/magic-link-email.md`
- `documentation/categories/email/email-verification-flow.md`
- `documentation/categories/email/transactional-email-rate-limiting-workers.md`
- `documentation/categories/cloudflare/d1-patterns.md`
