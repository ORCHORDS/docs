...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/patterns/agent-debugging-2026.md` and `documentation/categories/lessons/agent-self-correction.md`.
...
- `documentation/categories/patterns/agent-debugging-2026.md` — the trace + replay workflow
- `documentation/categories/patterns/agent-observability-2026.md` — OTel GenAI semconv spans
- `documentation/categories/patterns/agent-eval-2026.md` — the four dimensions of quality
- `documentation/categories/lessons/agent-self-correction.md` — what the agent does before escalation
- `documentation/categories/lessons/eval-driven-development-2026.md` — eval-as-deploy-gate
