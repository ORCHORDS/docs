...
- `documentation/categories/lessons/agent-iteration-discipline.md` — when to stop iterating on a task
- `documentation/categories/lessons/lazy-fail-evidence-discipline.md` — same discipline, applied to verification
- `documentation/categories/lessons/scope-discipline.md` — keep self-correction concerns out of unrelated PRs
- `documentation/categories/patterns/multi-agent-orchestration.md` — the topology that makes an independent critic possible
- `documentation/categories/patterns/agent-context-engineering-2026.md` — where the reflection memory lives
- `documentation/categories/patterns/agent-cost-optimization.md` — Reflexion's N× cost is a budget line item
- `documentation/categories/patterns/agent-skill-design.md` — the Claude Code "self-improving skills" pattern is a special case of this lesson
