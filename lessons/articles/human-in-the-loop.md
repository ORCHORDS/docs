...
- **Author**: kb-batch-2
- **Status**: Active; complements `documentation/categories/lessons/agent-iteration-discipline.md` and `documentation/categories/lessons/when-to-ask-vs-push.md`.
...
- `documentation/categories/lessons/agent-iteration-discipline.md` — the "when to stop" rule that HITL overrides
- `documentation/categories/lessons/when-to-ask-vs-push.md` — when asking is the right move
- `documentation/categories/lessons/agent-self-correction.md` — what the agent does *before* escalation
- `documentation/categories/security/ai-agent-security.md` — Tool-Input/Output firewalls and Rule of Two complement HITL
- `documentation/categories/patterns/multi-agent-orchestration.md` — where the approval boundaries sit in a multi-agent system
- `documentation/categories/cloudflare/sandbox-2026.md` — secure credential injection via egress proxy is one implementation of "the agent that reasons never holds write credentials"
