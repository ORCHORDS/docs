...
- `documentation/categories/monitoring/metric-aggregation-cron-d1.md` — metric ingestion pipeline
- `documentation/categories/monitoring/workers-error-budget-burn-rate.md` — SLO burn-rate alerting
- `documentation/categories/monitoring/on-call-rotation-pagerduty.md` — alert routing
