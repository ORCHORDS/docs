...
- `documentation/categories/monitoring/workers-distributed-tracing-otel.md` — trace propagation
- `documentation/categories/monitoring/workers-anomaly-detection-zscore.md` — anomaly detection
- `documentation/categories/monitoring/cost-per-request-tracking.md` — cost tracking
