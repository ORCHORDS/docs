...
- `documentation/categories/monitoring/cloudflare-workers-analytics.md`
- `documentation/categories/monitoring/metrics-vs-logs-vs-traces.md`
- `documentation/categories/monitoring/cost-monitoring-dashboards.md`
- `documentation/categories/cloudflare/workers-bindings.md`
