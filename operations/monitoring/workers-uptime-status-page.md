...
- `documentation/categories/monitoring/on-call-rotation-pagerduty.md` — incident escalation
- `documentation/categories/monitoring/synthetic-monitoring-playwright.md` — deep synthetic checks
