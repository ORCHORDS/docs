...
- `documentation/categories/deploy/workers-deployment-approval-gates.md` — gating migrations behind manual approval
- `documentation/categories/deploy/workers-version-pinning-gradual-rollout.md` — coordinating schema changes with gradual traffic rollout
