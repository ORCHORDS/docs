...
- `documentation/categories/deploy/workers-deployment-approval-gates.md` — requiring approval before starting a rollout
- `documentation/categories/deploy/workers-zero-downtime-d1-migration.md` — coordinating schema changes with traffic percentage splits
- `documentation/categories/deploy/workers-multi-region-failover-deploy.md` — failing over between accounts during a bad rollout
